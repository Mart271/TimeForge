...
| 4 | KPI Management | ✅ | Templates support free-text names + role/department targeting. `metricType` is a fixed 4-value enum (COUNT/HOURS/PERCENT/CURRENCY). Progress auto-updates from approved work logs, and Admins can record manual progress. Full Target vs Actual view on the dashboard. |
